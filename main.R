...
server <- function(session,input, output) {
  ...
  output$NewDiseaseResponseText<-renderText("<font size=4 color=red><b>Disable \"Browse button\", Please type disease name to check availibility first then upload excel.</b></font>")
